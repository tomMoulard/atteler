...
var eventSchemas = map[string]eventSchema{
	...
	RouteDecision: lifecycleEventSchema(eventSchema{
		...
		Metadata: map[string]metadataPolicy{
			...
			"actual_model":                    metadataSafe,
			"actual_output_tokens":            metadataSafe,
			"actual_provider":                 metadataSafe,
			...
			"rejection_reasons":               metadataSafe,
			"required_capabilities":           metadataSafe,
			"selected":                        metadataSafe,
			"selected_model":                  metadataSafe,
			"selected_provider":               metadataSafe,
