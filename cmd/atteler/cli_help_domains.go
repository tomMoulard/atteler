...
var cliHelpDomains = []cliHelpDomain{
	...
	},
	{
		...
		Commands: []cliCommandAlias{
			...
			{Name: "task-assign", Args: "<id:agent>", Summary: "claim a persistent task with a lease", Legacy: []string{"--task-assign"}},
			{Name: "task-complete", Args: "<id>", Summary: "mark a persistent task complete", Legacy: []string{"--task-complete"}},
			{Name: "task-heartbeat", Args: "<id>", Summary: "renew a persistent task lease", Legacy: []string{"--task-heartbeat"}},
			{Name: "task-update", Args: "<id>", Summary: "update persistent task coordination fields", Legacy: []string{"--task-update"}},
			{Name: "task-review", Args: "<id>", Summary: "move a persistent task into review", Legacy: []string{"--task-review"}},
			{Name: "task-fail", Args: "<id>", Summary: "mark a persistent task failed", Legacy: []string{"--task-fail"}},
			{Name: "task-cancel", Args: "<id>", Summary: "cancel a persistent task", Legacy: []string{"--task-cancel"}},
			{Name: "task-reopen", Args: "<id>", Summary: "reopen a persistent task for retry", Legacy: []string{"--task-reopen"}},
			{Name: "task-reconcile", Summary: "repair stale leases and dependency-derived task state", Legacy: []string{"--task-reconcile"}},
			{Name: "task-repair", Summary: "backup and repair a corrupt or conflicted task file", Legacy: []string{"--task-repair"}},
	...
	},
	{
		...
		Commands: []cliCommandAlias{
			...
			{Name: "git-history", Args: "<query>", Summary: "search local git history metadata/files/change evidence", Legacy: []string{"--git-history-search"}, JoinArgs: true},
...
var implicitFlagDefaults = map[string]string{
	...
	"git-history-limit":                   "5",
	"git-history-max-hunk-bytes":          "24576",
