...
| `multimodal_input` | supported — accepts typed image content parts and inline image `@path` references for JPEG, PNG, GIF, and WebP inputs | supported — accepts typed image content parts and inline image `@path` references for JPEG, PNG, GIF, and WebP inputs | supported — accepts typed image content parts and inline image `@path` references for JPEG, PNG, GIF, and WebP inputs | supported — accepts typed image content parts and inline image `@path` references for JPEG, PNG, GIF, and WebP inputs | supported — accepts typed image content parts and inline image `@path` references for JPEG, PNG, GIF, and WebP inputs |
